...
image: images/gemini/numberlink.png
#source: 
...
{{< embed notebooks/numberlink.ipynb#09a05cf9-9ebf-40a5-95b3-20408cb9033e >}}
</div>
...
$$
\sum_{q\in N(p)} \textcolor{blue}{x}_{q,k} = 1 \quad \forall p \in E_k, \; \forall k \in K 
$$
...
\sum_{q\in N(p)} \textcolor{blue}{x}_{q,k} 
