...
\begin{align}
\textcolor{blue}{x}_{i,j} &\le \textcolor{blue}{y}_{i,j-i} &\forall i<j, \; j>1 \\
\textcolor{blue}{x}_{i,j} &\le \textcolor{blue}{y}_{i,j-i+n} &\forall i>j, \; j>1
\end{align}

The above constaints enforce $\textcolor{blue}{x}_{i,j}=1 \implies \textcolor{blue}{y}_{i,j-i\pmod{n}}$.
...
Solving this problem with $n=6$ takes less than $1$ second with the default solver
in [PuLP](https://coin-or.github.io/pulp/) (CBC) and yields:

![](images/postman6_sol.png){width=60% fig-align="center"}

Solving this problem with $n=12$ takes less than $3$ seconds with the default solver
in [PuLP](https://coin-or.github.io/pulp/) (CBC) and yields:
